...
mkdir -p $dst
cd $1
echo "<html><head></head><body> <h3>Scanning the surface of potential energy when changing the C<sup>2</sup>-H distance for diazonium salts (DFT B3LYP 6-31G(d,p)):</h3> <ul>" > $dst/$1.html
